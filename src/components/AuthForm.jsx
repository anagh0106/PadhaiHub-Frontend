            ...
            <div className="relative rounded-xl overflow-hidden p-[1px] bg-gradient-to-r from-zinc-400/20 via-white/40 to-zinc-400/20 shadow-2xl">
                <div className="bg-black rounded-xl p-8 backdrop-blur-xl">
                    ...
                    {(view !== "login" || (view === "forgot-password" && forgotPasswordStep > 1)) && (
                        <button
                            onClick={resetView}
                            className="absolute top-4 left-4 p-2 rounded-full bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-white transition-all duration-300 shadow-md shadow-black/50 flex items-center gap-2"
                            aria-label="Go back"
                        >
                            <ArrowLeft size={20} />
                        </button>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full pl-10 pr-10 py-3 rounded-md bg-zinc-900/80 border border-zinc-700 text-white 
