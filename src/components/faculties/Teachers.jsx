...
//             </section>
//             {/* Teaching Philosophy */}
//             <div className="bg-white py-16 px-6 md:px-20 lg:px-36">
...
//                     {/* Right Box */}
//                     <div className="flex-1 bg-blue-50 rounded-xl p-6 shadow-sm">
...
//                                 <div>
//                                     <h4 className="font-semibold text-gray-800">Subject Matter Experts</h4>
...
//                                 <div>
//                                     <h4 className="font-semibold text-gray-800">Student-Friendly Approach</h4>
