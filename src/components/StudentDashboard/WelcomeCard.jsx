...
//             <motion.div
//                 className="bg-black text-white rounded-3xl p-8 shadow-[0_0_30px_#00bcd480] border border-[#222]"
...
//                     >
//                         <motion.div
//                             className="bg-[#111] border border-[#333] p-10 rounded-3xl shadow-[0_0_40px_#00bcd480] w-full max-w-lg relative"
//                             initial={{ scale: 0.8 }}
//                             animate={{ scale: 1 }}
//                             exit={{ scale: 0.8 }}
//                         >
...
//                     >
//                         <motion.div
//                             className="bg-[#111] border border-[#333] p-10 rounded-3xl shadow-[0_0_40px_#00bcd480] w-full max-w-lg"
//                             initial={{ scale: 0.8 }}
//                             animate={{ scale: 1 }}
//                             exit={{ scale: 0.8 }}
//                         >
